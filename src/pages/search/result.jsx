...
export class SearchResult extends Component {
	...
	searchBarFocus=()=>{
		if( this.props.searchType === "biz"){
			...
			browserHistory.replace( `${DIR}/qygSearch` );
		}else{
	...
	searchBarSearch=()=>{
		...
		if( searchType === "biz"){
			browserHistory.replace(`${DIR}/searchResult?key=${ encodeURIComponent(keyWord) }&type=biz`);
		}else{
			browserHistory.replace(`${DIR}/searchResult?key=${ encodeURIComponent(keyWord) }`);
		}
	...
	render(){
		...
		return(
			<div className="one-item-grid">
				<div className="one-item"   onClick={ this.props.toItem.bind( null,`${DIR}/item?item_id=${item_id}`) }>
