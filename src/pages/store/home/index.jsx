...
import {setExtraInfoGjzss} from 'js/util/dcpExtraInfo';
import './index.scss';
...
export class SearchBar extends Component {
    ...
    searchJump = () => {
            ...
            // 搜索事件采集
            let extraInfo = setExtraInfoGjzss(this.value, 200, 200, '跳转搜索结果页');
            sdk.dispatch('click', document.getElementById('searchBtn'), extraInfo);
    };
