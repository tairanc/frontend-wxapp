...
class SearchIndex extends Component {
	...
	searchSubmit = (key,link,param) => {
		...
		if( link ){
			...
			browserHistory.replace(`${DIR}/searchResult?key=${ encodeURIComponent(key)}&type=biz${(param&&param.shop)?'&shop='+param.shop:''}${(param&&param.coupon_id)?'&coupon_id='+param.coupon_id:''}`);
		}
	};
